...
if (gadgetHandler:IsSyncedCode()) then
  ...
  function gadget:UnitDestroyed(unitID,unitDefID)
    ...
    if newUnit then
      ...
      SendToUnsynced("lups_smoke_unit", newUnit, newDefID)
    end
  end
  
  --function gadget:UnitCreated(unitID,unitDefID)
  --  SendToUnsynced("lups_smoke_unit", unitID, unitDefID)
  --end
...
local function SpawnSmokeUnit(_,unitID,unitDefID)
...
function gadget:Shutdown()
  ...
  gadgetHandler:RemoveSyncAction("lups_smoke_unit")
end

function gadget:Initialize()
  gadgetHandler:AddSyncAction("lups_smoke_unit", SpawnSmokeUnit)
end
